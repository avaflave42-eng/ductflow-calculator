...
export const ductDefinitions: DuctDefinition[] = [
  ...
  createPlaceholderDuct("A7B", "Elbow", "Round, Mitered", "Mitered Round Elbow", "round"),
  createPlaceholderDuct("A7C", "Elbow", "Round, Mitered with Converging/Diverging Flow", "Round Elbow, Mitered with Converging/Diverging Flow", "round"),

  // Round > Transitions (Diverging Flow)
  createPlaceholderDuct("A8A", "Transition", "Conical Expansion", "Conical Expansion", "round"),
  createPlaceholderDuct("A8C", "Transition", "Round to Rectangular", "Round to Rectangular Expansion", "round"),
  ...
  // Rectangular > Elbows
  createPlaceholderDuct("A7D", "Elbow", "Mitered Rectangular", "Mitered Rectangular", "rectangular"),
  createPlaceholderDuct("A7E", "Elbow", "Mitered, with Converging/Diverging Flow", "Mitered, with Converging/Diverging Flow", "rectangular"),
  createPlaceholderDuct("A7F", "Elbow", "Smooth Radius without Vanes, 90°", "Smooth Radius without Vanes, 90°", "rectangular"),
  createPlaceholderDuct("A7G", "Elbow", "Smooth Radius with Splitter Vanes", "Smooth Radius with Splitter Vanes", "rectangular"),
  ...
  createPlaceholderDuct("A7I", "Elbow", "Z-Shaped (W/H=1)", "Z-Shaped (W/H=1)", "rectangular"),
  createPlaceholderDuct("A7J", "Elbow", "Different Planes", "Different Planes", "rectangular"),
  createPlaceholderDuct("A7L", "Elbow", "Wye or Tee Shape", "Wye or Tee Shape", "rectangular"),

  // Rectangular > Transitions (Diverging Flow)
  createPlaceholderDuct("A8B", "Transition", "Pyramidal Expansion", "Pyramidal Expansion", "rectangular"),
  createPlaceholderDuct("A8D", "Transition", "Rectangular to Round", "Rectangular to Round", "rectangular"),
